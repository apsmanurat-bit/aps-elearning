...
# 2. Gaya Visual (Memastikan teks putih agar terbaca)
st.markdown("""
<style>
    .stApp {
...
# 4. LINK DATABASE (FORMAT SPESIFIK UNTUK SHEET FORM RESPONSES 1)
# SHEET_ID dan GID sudah disesuaikan dengan data di gambar Bapak
...
if menu == "Akses Kelas & Absensi":
    ...
    # --- MENU ENROLLMENT (Link Panjang yang Stabil) ---
    ...
    if nim_input:
        try:
            ...
            # Cari NIM mahasiswa (bersihkan spasi dan pastikan format teks)
            ...
            st.error("Gagal memuat database. Pastikan menu 'Share' di Google Sheets sudah 'Anyone with the link'.")
    ...
    st.title("❓ Bantuan")
    st.write("Hubungi Pak Anggiat Simamora di kantor dosen English Dept.")